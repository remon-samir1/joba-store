...
const products = [
  {
    id: 1,
    name: "Herbal Pain Relief",
    description: "Natural pain relief formula",
    price: 384,
    originalPrice: 454,
    image:
  ...
  },
  {
    ...
    description: "Natural digestive health formula",
    price: 340,
    image:
      "https://cdn.builder.io/api/v1/image/assets/TEMP/cadd4badf0dd90d25f5e7f4b5a15251a6a065f26?width=400",
    onSale: false,
      ...
      <section className="relative h-96 bg-primary overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 h-full flex items-center">
          <div className="text-white">
            ...
            <h1 className="text-6xl font-bold mb-6">Natural Remedies</h1>
            <p className="text-xl max-w-2xl">
              Discover the power of nature with our carefully curated selection
              of natural remedies and herbal solutions for your wellness
              journey.
            </p>
          </div>
        </div>
