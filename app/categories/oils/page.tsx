...
const products = [
  {
    ...
    price: 45,
    image:
      "https://cdn.builder.io/api/v1/image/assets/TEMP/18f7ca4fd56dd5b1b2f81c6c36d55b49e77ff494?width=400",
    onSale: false,
  },
  {
    id: 12,
    name: "Tea Tree Oil",
    description: "Natural antiseptic and antimicrobial",
    price: 38,
    originalPrice: 48,
    image:
      "https://cdn.builder.io/api/v1/image/assets/TEMP/18f7ca4fd56dd5b1b2f81c6c36d55b49e77ff494?width=400",
  ...
  },
  {
    id: 13,
    name: "Eucalyptus Oil",
    description: "Refreshing and invigorating oil",
    price: 42,
    image:
      "https://cdn.builder.io/api/v1/image/assets/TEMP/18f7ca4fd56dd5b1b2f81c6c36d55b49e77ff494?width=400",
    onSale: false,
      ...
      <section className="relative h-96 bg-primary overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 h-full flex items-center">
          <div className="text-white">
            ...
            <h1 className="text-6xl font-bold mb-6">Essential Oils</h1>
            <p className="text-xl max-w-2xl">
              Experience the therapeutic power of nature with our premium
              collection of pure, therapeutic-grade essential oils.
            </p>
          </div>
        </div>
      </section>
