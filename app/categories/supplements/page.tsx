...
const products = [
  {
    ...
    price: 89,
    image:
      "https://cdn.builder.io/api/v1/image/assets/TEMP/a384110f0289f02b35a0a81b2b29b72bba5a51b8?width=400",
    onSale: false,
  },
  {
    id: 22,
      ...
      <section className="relative h-96 bg-primary overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 h-full flex items-center">
          <div className="text-white">
            ...
            <h1 className="text-6xl font-bold mb-6">Supplements</h1>
            <p className="text-xl max-w-2xl">
              Premium nutritional supplements to support your health and
              wellness goals with scientifically-backed formulations.
            </p>
          </div>
        </div>
      </section>
