...
export default function EditProductPage() {
  return (
    <div className="flex-1 overflow-auto">
      <DashboardHeader title="Edit Products" />
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <Input
                    id="product-name"
                    defaultValue="Seasonal Allergies"
                    className="mt-1"
                  />
                </div>
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    defaultValue="Lorem ipsum dolor sit amet consectetur. Lectus amet massa viverra molestudis. Nullam sagittis morbi ac sagittis mattis, In mauris tellus ut molestie lectus mauris, hendrerit ex massa hac in. Amet nec id ultrices aliquam viverra lacus."
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <div className="flex items-center space-x-2 mt-1">
                      ...
                      <Input defaultValue="EGP 900.89" className="flex-1" />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-2 mt-2">
                      <Checkbox id="tax-yes" defaultChecked />
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <div className="space-y-2 mt-2">
                        <Input defaultValue="10kg" />
                        <Input defaultValue="1 liter" />
                        <Input defaultValue="1 box" />
                      </div>
                    </div>
                    <div>
                      <Label>Variation Pricing</Label>
                      <div className="space-y-2 mt-2">
                        <Input defaultValue="EGP 350" />
                        <Input defaultValue="EGP 300" />
                        <Input defaultValue="EGP 300" />
                      </div>
                    </div>
                  </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center space-x-2">
                  <Switch id="unlimited" defaultChecked />
                  <Label htmlFor="unlimited">Unlimited</Label>
                </div>

                <div className="space-y-2">
                  <div className="flex items-center space-x-2">
                    <Checkbox id="best-seller" defaultChecked />
              ...
              <CardContent className="space-y-4">
                ...
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                  <div className="w-full h-40 bg-gray-100 rounded-lg flex items-center justify-center mb-4">
                    <span className="text-gray-500">Current Product Image</span>
                  </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <Select defaultValue="medical-mixtures">
                    <SelectTrigger className="mt-1">
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
